...
{
    /// <summary>
    ///     Ensures that a <see cref="TimeSpan" /> value is after the specified minimum time; otherwise, throws an
    ...
    /// </param>
    /// <returns>
    ///     The input <see cref="TimeSpan" /> value if it is after the specified minimum time; otherwise, throws an
    ///     exception.
    /// </returns>
    /// <exception cref="ArgumentOutOfRangeException">
    ///     Thrown when the <see cref="TimeSpan" /> value is not after the specified
    ///     minimum time.
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TimeSpan EnsureFuture(
        this TimeSpan value,
        TimeSpan minTime,
    ...
    /// <summary>
    ///     Ensures that a <see cref="DateTime" /> value is after the specified minimum date and time; otherwise, throws an
    ///     <see cref="ArgumentOutOfRangeException" />.
    /// </summary>
    ...
    /// </param>
    /// <returns>
    ///     The input <see cref="DateTime" /> value if it is after the specified minimum date and time; otherwise, throws
    ///     an exception.
    /// </returns>
    /// <exception cref="ArgumentOutOfRangeException">
    ///     Thrown when the <see cref="DateTime" /> value is not after the specified
    ///     minimum date and time.
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DateTime EnsureFuture(
        this DateTime value,
    ...
    /// <summary>
    ///     Ensures that a <see cref="DateTimeOffset" /> value is after the specified minimum date and time; otherwise, throws
    ///     an <see cref="ArgumentOutOfRangeException" />.
    /// </summary>
    /// <param name="value">The <see cref="DateTimeOffset" /> value to check.</param>
    /// <param name="minDateTimeOffset">
    ///     The minimum <see cref="DateTimeOffset" /> value that <paramref name="value" /> must be
    ///     after.
    /// </param>
    /// <param name="exceptionCreator">
    ///     Optional. A function to create a custom exception. If not provided, a standard
    ...
    /// </param>
    /// <returns>
    ///     The input <see cref="DateTimeOffset" /> value if it is after the specified minimum date and time; otherwise,
    ///     throws an exception.
    /// </returns>
    /// <exception cref="ArgumentOutOfRangeException">
    ///     Thrown when the <see cref="DateTimeOffset" /> value is not after the
    ///     specified minimum date and time.
    /// </exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DateTimeOffset EnsureFuture(
