...
{
    /// <summary>
    ///     Ensures that the length of a value obtained using an <see cref="int" /> length selector does not exceed the maximum
    ...
    ///     <paramref name="lengthSelector" /> exceeds the maximum length.
    /// </exception>
    ...
    /// <summary>
    ///     Ensures that the length of a value obtained using a <see cref="long" /> length selector does not exceed the maximum
    ///     length; otherwise, throws an <see cref="ArgumentException" />.
    /// </summary>
    /// <typeparam name="T">The type of the value to check.</typeparam>
    /// <param name="value">The value to check.</param>
