...
public static partial class EnsureExtensions
{
    ...
    /// <summary>
    /// Ensures that the value is greater than or equal to the specified minimum value using a custom exception creator delegate.
    /// </summary>
    /// <typeparam name="T">The type of the value to check.</typeparam>
    /// <param name="value">The value to check.</param>
    /// <param name="minValue">The minimum allowed value.</param>
    /// <param name="exceptionCreator">A delegate that creates an exception if the value is less than the specified minimum value.</param>
    /// <param name="paramName">The name of the parameter to include in the exception message.</param>
    /// <returns>The original value if it is greater than or equal to the specified minimum value.</returns>
    /// <exception cref="Exception">
    /// Thrown when the value is less than the specified minimum value, as created by the <paramref name="exceptionCreator"/> delegate.
    /// </exception>
    public static T EnsureGreaterThanEqual<T>(
        this T value,
        T minValue,
