...
{
    /// <summary>
    /// Ensures that a string represents a valid URI according to the specified <paramref name="uriKind"/>; otherwise, throws an <see cref="ArgumentException"/>.
    /// </summary>
    /// <param name="value">The string value to check.</param>
    /// <param name="uriKind">Optional. The <see cref="UriKind"/> to use when creating the URI. Default is <see cref="UriKind.RelativeOrAbsolute"/>.</param>
    ...
    /// <exception cref="ArgumentException">Thrown when the string does not represent a valid URI according to the specified <paramref name="uriKind"/>.</exception>
