...
{
    /// <summary>
    ///     Ensures that the value contains a specific element. For collections, it checks if the element is present; for
    ///     enums, it checks if the enum value matches the element.
    /// </summary>
