...
{
    /// <summary>
    ///     Ensures that the length of a value obtained using an <see cref="int" /> length selector is at least the minimum
    ...
    ///     <paramref name="lengthSelector" /> is less than the minimum length.
    /// </exception>
    ...
    /// <summary>
    ///     Ensures that the length of a value obtained using a <see cref="long" /> length selector is at least the minimum
    ///     length; otherwise, throws an <see cref="ArgumentException" />.
    /// </summary>
    /// <typeparam name="T">The type of the value to check.</typeparam>
    /// <param name="value">The value to check.</param>
